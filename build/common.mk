...
COMMON_CFLAGS += -I$(ROOT)/arch/$(SUBARCH)/include
COMMON_AFLAGS += -I$(ROOT)/arch/$(SUBARCH)/include
...
link-$(1) := $(ROOT)/arch/$(SUBARCH)/link-$(1).lds
head-$(1) := $(ROOT)/arch/$(SUBARCH)/$($(1)_guest)/head-$(1).o

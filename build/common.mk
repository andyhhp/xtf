...
COMMON_CFLAGS += -I$(ROOT)/arch/$(BASE_ARCH)/include
COMMON_AFLAGS += -I$(ROOT)/arch/$(BASE_ARCH)/include
...
link-$(1) := $(ROOT)/arch/$(BASE_ARCH)/link-$(1).lds
head-$(1) := $(ROOT)/arch/$(BASE_ARCH)/$($(1)_guest)/head-$(1).o
